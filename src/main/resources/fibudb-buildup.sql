...
-- -----------------------------------------------------
-- Table `fibudb`.`Account_AccountChart`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fibudb`.`Account_AccountChart` (
  `aacID` INT NOT NULL AUTO_INCREMENT,
  `accountID` INT NOT NULL,
  `accountChartID` INT NOT NULL,
  PRIMARY KEY (`aacID`),
  INDEX `aac-Account-FK_idx` (`accountID` ASC) VISIBLE,
  INDEX `aac-AccountChart-FK_idx` (`accountChartID` ASC) VISIBLE,
  CONSTRAINT `aac-Account-FK`
    FOREIGN KEY (`accountID`)
    REFERENCES `fibudb`.`Account` (`accountID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `aac-AccountChart-FK`
    FOREIGN KEY (`accountChartID`)
    REFERENCES `fibudb`.`AccountChart` (`accountChartID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
